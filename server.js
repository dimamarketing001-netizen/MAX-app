...
// --- Ключевая часть ---
// Мы говорим Express, что для всех запросов, начинающихся с /page3,
// нужно искать файлы в папке staticPath (т.е. в папке dist).
app.use('/page3', express.static(staticPath));

// Эта часть нужна, чтобы при обновлении страницы на /page3/profile
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`Приложение доступно по адресу http://localhost:${PORT}/page3/`);
});
